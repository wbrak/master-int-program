...
- Secuencial: Ejecuta una a una todas las líneas de un proceso hasta finalizar. [Diagrama secuencial](/diagramas/Secuencial.png "Diagrama secuencial")  
- Condicional: Ejecuta un proceso dependiendo de una serie de condiciones que se puedan dar. [Diagrama condicional](/diagramas/Condicional.png "Diagrama secuencial")
- Iterativa: Un proceso puede ser ejecutado un número indeterminado de veces basado en condiciones. [Diagrama iterativa](/diagramas/Secuencial.png "Diagrama secuencial")
